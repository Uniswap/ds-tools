...
WHERE
--  address IN ('0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8')
  -- AND
   topics[SAFE_OFFSET(0)] = '0x0c396cd989a39f4459b5fa1aed6a9a8dcdbc45908acfd67e028cd568da98982c'
)
,parsed_mint_logs AS
  (SELECT
    logs.block_timestamp AS block_timestamp
...
-- address IN ('0x8ad599c3a0ff1de082011efddc58f1908eb6e6d8')
  -- AND 
  topics[SAFE_OFFSET(0)] = '0x7a53080ba414158be7ec69b987b5fb7d07dee101fe85488f0853ae16239d0bde'
)
SELECT
     block_timestamp
     ,block_number
    ...
    ,cast(parsed.tickLower as BIGNUMERIC) AS `tickLower`
    ,cast(parsed.tickUpper as BIGNUMERIC) AS `tickUpper`
    ,cast(parsed.amount as BIGNUMERIC) AS `amount`
...
SELECT
    ...
    ,cast(parsed.tickLower as BIGNUMERIC) AS `tickLower`
    ,cast(parsed.tickUpper as BIGNUMERIC) AS `tickUpper`
    ,cast(parsed.amount as BIGNUMERIC)*-1 AS `amount`
    ,parsed.amount0 AS `amount0`
    ,parsed.amount1 AS `amount1`
    ,-1 AS `type`
