...
select md.date, md.pct, md.block_number, md. address, md.marketdepth as depth0,
       ...
       pd.price, md.marketdepth_daily/pd.price as depth1
from uniswap.marketdepth_daily md left join uniswap.pools_tokens_decimals ptd on md.address=ptd.pool
